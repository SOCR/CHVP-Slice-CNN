...
split:
	python3 ./src/train_test_split.py -ratio=0.7 -prefix="reg" -data_source="../Data/Registration" -corpus_path="./2D_CNN/corpus"
	python3 ./src/train_test_split.py -ratio=0.7 -prefix="pure" -data_source="../Data/Pure_Scaling" -corpus_path="./2D_CNN/corpus"

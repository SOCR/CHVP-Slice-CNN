...
python src/model_generator_CNN.py -model_name=$generated_model -num_sessions_each_dim=$num_sessions_each_dim -dropout=$drop_out
python src/train_CNN.py -load=$generated_model -save=$save_model -num_epoch=$num_epoch -train_file_dir=$train_file_dir -test_file_dir=$test_file_dir -num_sessions_each_dim=$num_sessions_each_dim
